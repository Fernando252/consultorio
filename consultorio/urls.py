...
from login.views import ver_cita,citas_t,CitaListView,registrar_cita,index, ver_casos,casos_abogado,registro_abogado, registro_cliente, login_cliente, subir_documento, nueva_cita, eliminar_cita, editar_cita
